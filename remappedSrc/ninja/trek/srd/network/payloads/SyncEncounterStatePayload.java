...
public record SyncEncounterStatePayload(
    ...
    public static final PacketCodec<RegistryByteBuf, InitiativeEntry> INITIATIVE_ENTRY_CODEC = PacketCodec.tuple(
        ...
        PacketCodecs.INTEGER, InitiativeEntry::initiativeRoll,
        PacketCodecs.INTEGER, InitiativeEntry::dexModifier,
        InitiativeEntry::new
    );
    ...
    public static final PacketCodec<RegistryByteBuf, SyncEncounterStatePayload> CODEC = PacketCodec.tuple(
        ...
        PacketCodecs.INTEGER, SyncEncounterStatePayload::currentTurnIndex,
        PacketCodecs.INTEGER, SyncEncounterStatePayload::roundNumber,
        PacketCodecs.BOOL, SyncEncounterStatePayload::ended,
