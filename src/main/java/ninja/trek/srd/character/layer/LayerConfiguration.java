 ...
 * should be rendered.
 *
 * Based on GECKOLIB_ARCHITECTURE.md and LAYER_SYSTEM.md specifications.
 */
public class LayerConfiguration {
    ...
    // Body variant getters/setters

    public int getBodyVariant() {
        return bodyVariant;
    }

    public void setBodyVariant(int bodyVariant) {
        this.bodyVariant = bodyVariant;
    }

    public int getLegsVariant() {
        return legsVariant;
    }

    public void setLegsVariant(int legsVariant) {
        this.legsVariant = legsVariant;
    }

    public int getArmsVariant() {
        return armsVariant;
    }

    public void setArmsVariant(int armsVariant) {
        this.armsVariant = armsVariant;
    }

    public int getHeadVariant() {
        return headVariant;
    }

    public void setHeadVariant(int headVariant) {
    ...
    public void setHelmetModel(String helmetModel) {
        ...
        // Helmets typically hide hair and ears
        if (helmetModel != null) {
            this.showHair = false;
            this.showEars = false;
        }
    ...
    public String getChestArmorModel() {
        return chestArmorModel;
    }

    public void setChestArmorModel(String chestArmorModel) {
        this.chestArmorModel = chestArmorModel;
    }

    public String getLegArmorModel() {
        return legArmorModel;
    }

    public void setLegArmorModel(String legArmorModel) {
        this.legArmorModel = legArmorModel;
    }

    public String getBootArmorModel() {
        return bootArmorModel;
    }

    public void setBootArmorModel(String bootArmorModel) {
        this.bootArmorModel = bootArmorModel;
    }
    ...
    public void setCapeModel(String capeModel) {
        this.capeModel = capeModel;
    }

    public String getMainHandModel() {
        return mainHandModel;
    }

    public void setMainHandModel(String mainHandModel) {
        this.mainHandModel = mainHandModel;
    }

    public String getOffHandModel() {
        return offHandModel;
    }

    public void setOffHandModel(String offHandModel) {
        this.offHandModel = offHandModel;
    }
    ...
    public void setClothingTexture(String clothingTexture) {
        this.clothingTexture = clothingTexture;
    }

    public Map<String, String> getArmorTextures() {
        return armorTextures;
    }

    public void setArmorTexture(String slot, String texture) {
        this.armorTextures.put(slot, texture);
    }

    // Visibility getters/setters

    public boolean isShowHair() {
        return showHair;
    }

    public void setShowHair(boolean showHair) {
        this.showHair = showHair;
    }

    public boolean isShowEars() {
        return showEars;
    }

    public void setShowEars(boolean showEars) {
        this.showEars = showEars;
    }
    ...
    /**
     * Check if a specific equipment slot is filled.
     */
    ...
    /**
     * Get equipment model name for a specific slot.
     */
